...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng akbmn = new LatLng(-7.668759, 109.651783);
        mMap.addMarker(new MarkerOptions().position(akbmn).title("Marker in Alun-alun Kebumen"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(akbmn));
